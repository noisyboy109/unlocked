...
Pushbox.Level21.prototype = {
    ...
    spot1 = new SpotPlatform(this.game,game.world.width-930, game.world.height-120, 'spots', this.spot);
     //box
    box1 = new BoxPlatform(this.game, game.world.width-480, game.world.height-540, 'box');
    game.add.existing(box1);

    //key
    this.key = this.add.physicsGroup();
    key1 = new KeyPlatform(this.game,game.world.width-500, game.world.height -250, 'redkey', this.key);
