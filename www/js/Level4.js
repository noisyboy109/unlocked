Pushbox.Level4 = function(game){
  ...
  this.points = {
    ...
    key2 = new KeyPlatform(this.game,game.world.width-420, game.world.height -480, 'redkey', this.key);
    ...
    lock2 = game.add.sprite(game.world.width-238,game.world.height-658,'lock2');
