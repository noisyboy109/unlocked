Pushbox.Level41_1 = function(game){
...
Pushbox.Level41_1.prototype = {
    ...
    //box
    box1 = new BoxPlatform(this.game, game.world.width-690, game.world.height-180, 'box');
    game.add.existing(box1);
    box2 = new BoxPlatform(this.game, game.world.width-330, game.world.height-180, 'box');
    ...
    key2 = new KeyPlatform(this.game,game.world.width-230, game.world.height -208, 'redkey', this.key);
