Pushbox.Level51 = function(game){

	  this.bmd = null;
  // points arrays - one for x and one for y
  this.points = {
    'x': [420,720,720,420,720,720,720,420,420],
    'y': [120,120,420,420,420,120,420,420,119]
};

};

Pushbox.Level51.prototype = {
	...
	game.add.tileSprite(60, 60, game.world.width+120, game.world.height, 'background');
	 ...
	 //the map
    map = game.add.tilemap('map51', 60, 60);
    ...
    spot1 = new SpotPlatform(this.game,game.world.width-930, game.world.height-540, 'spots', this.spot);
    spot1.body.setSize(10,10,25,30,null);
    spot2 = new SpotPlatform(this.game,game.world.width-930, game.world.height-240, 'spots', this.spot);
    spot2.body.setSize(10,10,25,30,null);
    spot3 = new SpotPlatform(this.game,game.world.width-90, game.world.height-420, 'spots', this.spot);
    spot3.body.setSize(10,10,25,30,null);

    //box   
    box1 = new BoxPlatform(this.game, game.world.width-690, game.world.height-477, 'box');
    game.add.existing(box1);
    box2 = new BoxPlatform(this.game, game.world.width-690, game.world.height-297, 'box');
    game.add.existing(box2);
    box3 = new BoxPlatform(this.game, game.world.width-210, game.world.height-477, 'box');
    ...
    key1 = new KeyPlatform(this.game,game.world.width-400, game.world.height -378, 'redkey', this.key);
    key2 = new KeyPlatform(this.game,game.world.width-900, game.world.height -380, 'yellowkey', this.key);

    //lock
    lock1 = game.add.sprite(game.world.width-660,game.world.height-378,'lock1');
    lock1.enableBody = true;
    game.physics.arcade.enable(lock1);
    lock1.body.setSize (56,56,0,0);
    lock1.body.immovable = true;

    lock2 = game.add.sprite(game.world.width-180,game.world.height-420,'lock2');
