Pushbox.Level3_1 = function(game){
 ...
 this.points1 = {
    ...
    //box
    box1 = new BoxPlatform(this.game, game.world.width-580, game.world.height-480, 'box');
    game.add.existing(box1);
    box2 = new BoxPlatform(this.game, game.world.width-580, game.world.height-300, 'box');
    ...
    key2 = new KeyPlatform(this.game,game.world.width-660, game.world.height -400, 'redkey', this.key);
    ...
    var posx1 = this.math.linearInterpolation(this.points1.a, this.o);
    var posy1 = this.math.linearInterpolation(this.points1.b, this.o);
    enemy1.x = posx1;
    enemy1.y = posy1;
