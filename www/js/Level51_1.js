Pushbox.Level51_1 = function(game){
...
Pushbox.Level51_1.prototype = {
    ...
    key1 = new KeyPlatform(this.game,game.world.width-400, game.world.height -478, 'redkey', this.key);
    key2 = new KeyPlatform(this.game,game.world.width-500, game.world.height -280, 'yellowkey', this.key);

    //lock
    lock1 = game.add.sprite(game.world.width-955,game.world.height-537,'lock1');
    lock1.enableBody = true;
    game.physics.arcade.enable(lock1);
    lock1.body.setSize (56,56,0,0);
    lock1.body.immovable = true;

    lock2 = game.add.sprite(game.world.width-955,game.world.height-237,'lock2');
