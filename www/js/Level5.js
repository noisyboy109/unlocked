...
Pushbox.Level5.prototype = {
    ...
    spot3 = new SpotPlatform(this.game,game.world.width-930, game.world.height-420, 'spots', this.spot);
    ...
    box3 = new BoxPlatform(this.game, game.world.width-807, game.world.height-417, 'box');
