...
Pushbox.Level61.prototype ={
    ...
    spot3 = new SpotPlatform(this.game,game.world.width-510, game.world.height-600, 'spots', this.spot);
    ...
    box2 = new BoxPlatform(this.game, game.world.width-270, game.world.height-297, 'box');
