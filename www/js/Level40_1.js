Pushbox.Level40_1 = function(game){
...
Pushbox.Level40_1.prototype = {
    ...
    spot1 = new SpotPlatform(this.game,game.world.width-270, game.world.height-120, 'spots', this.spot);
    spot1.body.setSize(10,10,25,30,null);
    spot2 = new SpotPlatform(this.game,game.world.width-750, game.world.height-120, 'spots', this.spot);
    spot2.body.setSize(10,10,25,30,null);

   
    //box
    box1 = new BoxPlatform(this.game, game.world.width-810, game.world.height-470, 'box');
    game.add.existing(box1);
    box2 = new BoxPlatform(this.game, game.world.width-210, game.world.height-470, 'box');
