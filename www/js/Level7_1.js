...
Pushbox.Level7_1.prototype = {
	...
	this.add.tileSprite(60, 60, game.world.width+120, game.world.height, 'background');
	 ...
	 //the map
    map = game.add.tilemap('map7', 60, 60);
    ...
    spot1 = new SpotPlatform(this.game,game.world.width-930, game.world.height-120, 'spots', this.spot);
    spot1.body.setSize(10,10,25,30,null);
    spot2 = new SpotPlatform(this.game,game.world.width-930, game.world.height-660, 'spots', this.spot);
    spot2.body.setSize(10,10,25,30,null);
   
    //box   
    box1 = new BoxPlatform(this.game, game.world.width-390, game.world.height-175, 'box');
    game.add.existing(box1);
    box2 = new BoxPlatform(this.game, game.world.width-390, game.world.height-600, 'box');
    ...
    key1 = new KeyPlatform(this.game,game.world.width-700, game.world.height -340, 'yellowkey', this.key);
    key2 = new KeyPlatform(this.game,game.world.width-320, game.world.height -640, 'redkey', this.key);

    //lock
    lock1 = game.add.sprite(game.world.width-950,game.world.height-120,'lock1');
    lock1.enableBody = true;
    game.physics.arcade.enable(lock1);
    lock1.body.setSize (56,56,0,0);
    lock1.body.immovable = true;

    lock2 = game.add.sprite(game.world.width-950,game.world.height-660,'lock2');
    ...
    // Draw the path
    for (var j = 0; j < 1; j += this.increment) {
      var posx5 = this.math.linearInterpolation(this.points6.i, j);
      var posy5 = this.math.linearInterpolation(this.points6.j, j);
	...
	update: function(game){
        ...
        this.timer2.loop(.01, this.plot4, this);
        this.timer2.start();
        }
 ...
 //    }
  ...
  plot5: function() {
    ...
    var posx4 = this.math.linearInterpolation(this.points5.g, this.k);
    var posy4 = this.math.linearInterpolation(this.points5.h, this.k);
    enemy1.x = posx4;
    enemy1.y = posy4;
    this.k += this.increment4;
    if (posy4>=361) {
  ...
  plot6: function() {
    ...
    var posx5 = this.math.linearInterpolation(this.points6.i, this.u);
    var posy5 = this.math.linearInterpolation(this.points6.j, this.u);
    enemy1.x = posx5;
    enemy1.y = posy5;
    this.u += this.increment5;
    if (posy5>=481) {
