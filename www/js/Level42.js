...
Pushbox.Level42.prototype = {
    ...
    spot1 = new SpotPlatform(this.game,game.world.width-510, game.world.height-240, 'spots', this.spot);
    spot1.body.setSize(10,10,25,30,null);
    spot2 = new SpotPlatform(this.game,game.world.width-510, game.world.height-120, 'spots', this.spot);
    ...
    key1 = new KeyPlatform(this.game,game.world.width-600, game.world.height -640, 'yellowkey', this.key);
    key2 = new KeyPlatform(this.game,game.world.width-420, game.world.height -640, 'redkey', this.key);

    //lock
    lock1 = game.add.sprite(game.world.width-690,game.world.height-258,'lock1');
    lock1.enableBody = true;
    game.physics.arcade.enable(lock1);
    lock1.body.setSize (56,56,0,0);
    lock1.body.immovable = true;

    lock2 = game.add.sprite(game.world.width-378,game.world.height-258,'lock2');
