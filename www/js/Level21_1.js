Pushbox.Level21_1 = function(game){
...
Pushbox.Level21_1.prototype = {
    ...
    //the map
    map = game.add.tilemap('map21', 60, 60);
    ...
    spot1 = new SpotPlatform(this.game,game.world.width-90, game.world.height-120, 'spots', this.spot);
     //box
    box1 = new BoxPlatform(this.game, game.world.width-480, game.world.height-240, 'box');
    game.add.existing(box1);

    //key
    this.key = this.add.physicsGroup();
    key1 = new KeyPlatform(this.game,game.world.width-500, game.world.height -600, 'redkey', this.key);

    //lock
    lock = game.add.sprite(game.world.width-510,game.world.height-418,'lock1');
    ...
    //setup our player
    player = game.add.sprite(game.world.width-120, game.world.height - 500, 'boy'); //create and position player
    ...
    update: function(game){
        ...
        if (this.checkOverlap(player,enemy1)){
