Pushbox.Level42_1 = function(game){
  ...
  this.points1 = {
    ...
    'h': [240,240,420,420,239]
	};
	
};

Pushbox.Level42_1.prototype = {
    ...
    //the map
    map = game.add.tilemap('map42', 60, 60);
    ...
    spot1 = new SpotPlatform(this.game,game.world.width-750, game.world.height-480, 'spots', this.spot);
    spot1.body.setSize(10,10,25,30,null);
    spot2 = new SpotPlatform(this.game,game.world.width-270, game.world.height-480, 'spots', this.spot);
    spot2.body.setSize(10,10,25,30,null);

    //box
    box1 = new BoxPlatform(this.game, game.world.width-840, game.world.height-197, 'box');
    game.add.existing(box1);
    box2 = new BoxPlatform(this.game, game.world.width-150, game.world.height-197, 'box');
    game.add.existing(box2);
    
    //key
    this.key = this.add.physicsGroup();
    key1 = new KeyPlatform(this.game,game.world.width-600, game.world.height -340, 'yellowkey', this.key);
    key2 = new KeyPlatform(this.game,game.world.width-420, game.world.height -640, 'redkey', this.key);

    //lock
    lock1 = game.add.sprite(game.world.width-780,game.world.height-480,'lock1');
    lock1.enableBody = true;
    game.physics.arcade.enable(lock1);
    lock1.body.setSize (56,56,0,0);
    lock1.body.immovable = true;

    lock2 = game.add.sprite(game.world.width-295,game.world.height-480,'lock2');
    ...
    //setup our player
    player = game.add.sprite(game.world.width-540, game.world.height - 378, 'boy'); //create and position player
